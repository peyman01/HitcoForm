<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="panelAdmin.aspx.cs" Inherits="HitcoForm.panelAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main class="main-content">
        ...
        <section class="content-area">
            <div class="menuName">افزودن و ویرایش کاربر</div>
